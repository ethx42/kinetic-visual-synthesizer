 ...
 * High-quality RGB channel separation
...
import chromaticAberrationVert from '$shaders/postprocessing/chromatic-aberration.vert.glsl?raw';
import chromaticAberrationFrag from '$shaders/postprocessing/chromatic-aberration.frag.glsl?raw';
 ...
 */
export class ChromaticAberrationEffect extends BasePostProcessingEffect {
	...
	// Chromatic aberration-specific parameters
	public offset: number = 0.02;

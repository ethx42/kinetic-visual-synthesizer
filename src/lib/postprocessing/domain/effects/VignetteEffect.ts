...
import vignetteVert from '$shaders/postprocessing/vignette.vert.glsl?raw';
import vignetteFrag from '$shaders/postprocessing/vignette.frag.glsl?raw';
...
/**
 * VignetteEffect - Edge darkening for cinematic focus
 */
export class VignetteEffect extends BasePostProcessingEffect {
	...
	updateUniforms(uniforms: EffectUniforms): void {
		...
		this.material.uniforms.uFeather.value = this.feather;
